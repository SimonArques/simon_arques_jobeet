...
namespace Ens\SimonBundle\Tests\Controller;
...
class JobControllerTest extends WebTestCase
{
    ...
    public function getMostRecentProgrammingJob()
    {
        ...
        $query = $em->createQuery('SELECT j from EnsSimonBundle:Job j 
    ...
    public function testIndex()
    {
        ...
        $this->assertEquals('Ens\SimonBundle\Controller\JobController::indexAction',
        ...
        $this->assertEquals('Ens\SimonBundle\Controller\JobController::showAction',
            $client->getRequest()->attributes->get('_controller'));
