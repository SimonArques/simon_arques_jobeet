    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/job')) {
            ...
            if (rtrim($pathinfo, '/') === '/job') {
                ...
                return array (  '_controller' => 'Ens\\SimonBundle\\Controller\\JobController::indexAction',  '_route' => 'job_index',);
            }
            not_job_index:
            ...
            if ($pathinfo === '/job/new') {
                ...
                return array (  '_controller' => 'Ens\\SimonBundle\\Controller\\JobController::newAction',  '_route' => 'job_new',);
            }
            not_job_new:
            ...
            if ($pathinfo === '/job/create') {
                ...
                return array (  '_controller' => 'Ens\\SimonBundle\\Controller\\JobController::createAction',  '_route' => 'job_create',);
            }
            not_job_create:

            // job_edit
            if (preg_match('#^/job/(?P<token>[^/]++)/edit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'job_edit')), array (  '_controller' => 'Ens\\SimonBundle\\Controller\\JobController::editAction',));
            }
            ...
            if (preg_match('#^/job/(?P<token>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'job_delete')), array (  '_controller' => 'Ens\\SimonBundle\\Controller\\JobController::deleteAction',));
            }
            not_job_delete:
            ...
            if (preg_match('#^/job/(?P<token>[^/]++)/extend$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'job_extend')), array (  '_controller' => 'Ens\\SimonBundle\\Controller\\JobController::extendAction',));
            }
            not_job_extend:
