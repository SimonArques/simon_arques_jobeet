 ...
 */
class Affiliate extends \Ens\SimonBundle\Entity\Affiliate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ens\\SimonBundle\\Entity\\Affiliate' . "\0" . 'id', '' . "\0" . 'Ens\\SimonBundle\\Entity\\Affiliate' . "\0" . 'url', '' . "\0" . 'Ens\\SimonBundle\\Entity\\Affiliate' . "\0" . 'email', '' . "\0" . 'Ens\\SimonBundle\\Entity\\Affiliate' . "\0" . 'token', '' . "\0" . 'Ens\\SimonBundle\\Entity\\Affiliate' . "\0" . 'created_at', '' . "\0" . 'Ens\\SimonBundle\\Entity\\Affiliate' . "\0" . 'category_affiliates');
        }
